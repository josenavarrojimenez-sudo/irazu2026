...
function whatsappWidgetHTML() {
  ...
  <style>
    ...
    .whatsapp-widget-button:hover .whatsapp-widget-inner {
    ...
    .whatsapp-widget-button:hover .whatsapp-widget-icon svg {
      transform: scale(1.1);
    }
    .whatsapp-widget-bg {
      position: absolute;
    ...
    .whatsapp-widget-button:hover .whatsapp-widget-bg {
      transform: scaleX(1);
    }
    .whatsapp-widget-button:active .whatsapp-widget-bg {
      opacity: 0;
    }
    .whatsapp-widget-button:active .whatsapp-widget-inner::after {
      opacity: 1;
    }
    .whatsapp-widget-inner::after {
      content: '';
      display: block;
      position: absolute;
      top: 2px;
